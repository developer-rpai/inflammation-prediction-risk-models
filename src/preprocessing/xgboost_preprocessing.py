...
def get_control_inflammation_cases_ids(X, icustay_ids):
    '''
    Returns the ids of the control and the inflammation cases in the dataset.
    ...
    -------
    dict
        The dictionary with the control and the inflammation cases ids
    '''
    controls = []
    cases = []
