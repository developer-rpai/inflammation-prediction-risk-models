...
def duplicated_ids_barplot(count_dict, title='', save_path=None, show=True):
    ...
    if save_path:
        plt.savefig('images/unique_ids_controls_inflammation.png', bbox_inches='tight')
    if show:
        plt.show()


def plot_inflammation_controls_prop_pie_chart(controls_static_variables_df, cases_static_variables_df, show=True, save_path=None):
    '''
    Plots a pie chart with the proportion of inflammation cases and controls
